...
{
	static char * KISSHFWebProc = NULL;
	if (!KISSHFWebProc)
		KISSHFWebProc = GetTemplateFromFile(1, "KISSHFWebProc.txt");

	int Len = sprintf(Buff, KISSHFWebProc, TNC->Port,
		TNC->WEB_COMMSSTATE, TNC->WEB_TNCSTATE, TNC->WebBuffer);
